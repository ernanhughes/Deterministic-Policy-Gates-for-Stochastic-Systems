...
from scripts.data.feverous_wiki_resolver import FeverousWikiDB
...
class Embedder:
    ...
    def __init__(self, model_name: str):
        ...
        try:
            ...
            from certum.embedding.hf_embedder import HFEmbedder  # type: ignore
            self._impl = HFEmbedder(model_name=model_name, backend="E:\\data\\global_embeddings.db")
        except Exception:
            try:
